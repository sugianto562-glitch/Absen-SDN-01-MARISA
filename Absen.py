...
def login_screen():
    ...
    with col2:
        ...
        with st.container(border=True):
            ...
            st.markdown("<hr><center style='color:white !important;'>Creativity by <b>Sugianto</b></center>", unsafe_allow_html=True)
...
st.markdown("""
    <div class="footer">
            ...
            <span>Sistem Informasi Sekolah Digital — Designed with ❤️ by <b>Sugianto (SDN 01 MARISA)</b></span>
        </marquee>
    </div>
""", unsafe_allow_html=True)
...
with col_cam:
    ...
    with st.expander("📝 Input Siswa Tidak Hadir (Sakit/Izin/Alpa)"):
        with st.form("manual"):
            ...
            if not df_s.empty:
                pilih = st.selectbox("Nama Siswa:", df_s['NISN'] + " - " + df_s['Nama'])
            else:
                pilih = ""
